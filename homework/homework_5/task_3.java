...
public class task_3 {
    ...
    {
        Board board = new Board(8);  // создаем Доску
        nextTurn(board); // запускаем расстановку ферзей
    }

    public static class queen // создаем класс ферзь
    {
        int x, y;
        static int count = 0;
    ...
    public static class Board // создаем класс доска
    {
        int size;
        int[][] cell;
        ...
        public void addQueen(queen queen, int index) // добавить ферзя
        {
